...
<body>
    ...
    <div class="container">
        ...
        <!-- Navigation Buttons -->
        <div class="buttons">
            <a href="<?php if($page <= 1){echo " # ";} else {echo "index.php?page=". $page - 1;} ?>"><button>Back</button></a>
            <a href="<?php if($page >= $totalPages){echo"#";} else{echo"index.php?page=".$page + 1 ;} ?>"><button>Next</button></a>
        </div>
    </div>
</body>
</html>
